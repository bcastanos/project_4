(function(){
    ...
    GlobalController.$inject = ['auth', 'user', '$rootScope', '$state', '$window']

    function GlobalController(auth, user, $rootScope, $state, $window){
        var vm = this
        ...
        function handleRequest(res) {
            $window.localStorage['email'] = vm.loginUser.email
            console.log(vm.loginUser.email)
